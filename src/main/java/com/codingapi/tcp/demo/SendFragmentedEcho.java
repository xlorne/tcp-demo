...
public class SendFragmentedEcho {
    ...
    private static final int COUNT = Integer.getInteger(COUNT_KEY, 300);
    ...
    public static void main(String[] args) throws PcapNativeException {
        ...
        String strSrcIpAddress = "10.0.0.235";
        String strSrcMacAddress = "fe:00:01:02:03:04"; // e.g. 12:34:56:ab:cd:ef

        String strDstIpAddress = "10.0.0.160"; // for InetAddress.getByName()
        String strDstMacAddress = "78:4f:43:90:44:e8"; // e.g. 12:34:56:ab:cd:ef
        ...
        try {
            ...
            PacketListener listener =
                    packet -> System.out.println(packet);
